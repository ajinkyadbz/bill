...
$arb = "<br />hello";
	if($_GET["shop"]) {
		$shop_name = "Shop : Gigmoz <br />";
	}
	if($_GET["product"]) {
		$product = "Product : Rosted Almonds <br />"	;
	}
	if($_GET["price"]) {
		$price = "Price : Rs.400 <br />"	;
	}
	if($_GET["tax"]) {
		$tax = "GST : 18% <br />";
	}
	if($_GET["expiry"]) {
		$expiry = "Expiry date: 20/10/2020 <br />";
	}
	if($_GET["quantity"]) {
		$quantity = "Quantity : 200 Grams <br />";
	}
...
if($_GET["check"] != "") {
	$this->query_data = "SELECT * FROM product WHERE product_name='$_GET[check]'";
				...
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							...
							<?php $auto_c = new auto_complete("stocks","1",null); ?>
							</datalist>						
							</div>

 							<div class="form-group">
								<div class="checkbox-inline1"><label><input type="checkbox" name="shop"> Shop Name </label></div>
								<div class="checkbox-inline1"><label><input type="checkbox" name="product"> Product Name </label></div> 							
								<div class="checkbox-inline1"><label><input type="checkbox" name="price"> Include Price </label></div>
								<div class="checkbox-inline1"><label><input type="checkbox" name="tax"> Include Tax </label></div>
								<div class="checkbox-inline1"><label><input type="checkbox" name="quantity"> Include Quantity </label></div>
								<div class="checkbox-inline1"><label><input type="checkbox" name="expiry"> Include Expiry </label></div>
							</div>
