...
<!-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  -->
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h2 class="title1">Edit Stocks</h2>
							...
							<form> 
								<div class="form-group">
									<div class="row">																				
										...
										<input type="text" class="form-control1" placeholder="Product Name">
										</div>
									...
									<div class="row">
										...
										<input type="text" class="form-control1" placeholder="Quantity">
										</div>									
									</div>
							...
							<form> 
								<div class="form-group">
									<div class="row">																				
										...
										<input type="text" class="form-control1" placeholder="HSN No. (Leave blank to retain original data.)">
										</div>
								...
								<div class="row">
									...
									<input type="text" class="form-control1" placeholder="Price (Leave blank to retain original data.)">
									</div>
																		
									<div class="col-md-5">
									<label for="exampleInputEmail1">Tax</label>
									<input type="text" class="form-control1" placeholder="Tax (Leave blank to retain original data.)">
									</div>
								</div>
								...
								<div class="row">
									...
									<input type="text" class="form-control1" placeholder="Unit (Leave blank to retain original data.)">
									</div>
									
									<div class="col-md-5">
									<label for="exampleInputEmail1">UPC</label>
									<input type="text" class="form-control1" placeholder="Barcode data (Leave blank to retain original data.)">
									</div>
								</div>
								
								<div class="row">
								<div class="col-md-5">								
									<label for="exampleInputEmail1">Expiry date: (Leave blank to retain original data.)</label>
									<input type="date" class="form-control1">
								</div>
								
									<div class="col-md-5">
									<label for="exampleInputEmail1">Quantity</label>
									<input type="text" class="form-control1" placeholder="Quantity (Leave blank to retain original data.)">
									</div>
								</div>					
								<div class="clearfix"> </div>
