							...
							<form> 
								<div class="form-group">
									<div class="row">																				
										...
										<input type="text" class="form-control1" placeholder="HSN No.">
										</div>
									</div>										
									...
									<div class="row">
										...
										<input type="text" class="form-control1" placeholder="Price">
										</div>
																			
										<div class="col-md-5">
										<label for="exampleInputEmail1">Tax</label>
										<input type="text" class="form-control1" placeholder="Tax">
										</div>
									</div>
									...
									<div class="row">
										...
										<input type="text" class="form-control1" placeholder="Unit">
										</div>
										
										<div class="col-md-5">
										<label for="exampleInputEmail1">UPC</label>
										<input type="text" class="form-control1" placeholder="Barcode data">
										</div>
									</div>
								</div>
								<div class="clearfix"> </div>
